...
public class DeleteAddressTest {
    ...
    @Test
    @Sql(scripts = "/data/sql/controllers/adminAddressRestController/delete/init.sql",
         executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    @Sql(scripts = "/data/sql/controllers/adminAddressRestController/delete/delete.sql",
         executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    public void deleteAddressTest() throws Exception {

        accessToken = obtainNewAccessToken("user1@mail.ru", "101", mockMvc);

        mockMvc.perform(delete("/api/admin/address/1")
    ...
    @Sql(scripts = "/data/sql/controllers/adminPersonRestController/delete/delete.sql",
         executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    public void negativeDeleteAddressTest() throws Exception {

        accessToken = obtainNewAccessToken("user1@mail.ru", "101", mockMvc);

        mockMvc.perform(delete("/api/admin/address/2")
                   .header("Authorization", "Bearer " + accessToken))
